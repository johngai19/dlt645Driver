...
class Connector {
  ...
  _publish() {
    ...
    const dltdata =object.assign({} ,this.meter.dltdata);
...
Config.get()
  .then((config) => {
    ...
    console.log(thingInfo.custom.meterSn);
    console.log(thingInfo.custom.updateInt);
    console.log(driverInfo);

    thingInfos.forEach((thingInfo) => {
      const meter = new Meter(meterSn=thingInfo.custom.meterSn, updateInt=thingInfo.custom.updateInt);//thingInfo.Config.custom.meterSn);
