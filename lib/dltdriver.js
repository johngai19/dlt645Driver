...
class DltDriver {
    constructor(portPath='ttyS4',updateInt=2000, meterList=[],portSet=Object.assign({}, defaultSet))
         {
        //meterList =meterListOr;
        //console.log(meterList);
        //console.log(updateInt);
        this._portPath=new String(portPath);
        this._portName=this._portPath.replace('tty','/dev/tty');
        this._port = new SerialPort(this._portName, portSet, (()=>console.log));
